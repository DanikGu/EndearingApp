...
using EndearingApp.Core.ProjectAggregate;
using EndearingApp.Core.Services;
using EndearingApp.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace EndearingApp.UnitTests.Core.Services
{
    public class ToDoItemSearchService_GetAllIncompleteItems
    {
        ...
        public async Task ReturnsErrorGivenDataAccessException()
        {
            ...
            _mockRepo
                .Setup(r => r.ListAsync(It.IsAny<ISpecification<ToDoItem>>()))
