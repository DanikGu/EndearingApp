...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidationSeverity', function() {
      beforeEach(function() {
        instance = EndearingAppweb.ValidationSeverity;
      });

      it('should create an instance of ValidationSeverity', function() {
        // TODO: update the code to test ValidationSeverity
