...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeltaItemKind', function() {
      beforeEach(function() {
        instance = EndearingAppweb.DeltaItemKind;
      });

      it('should create an instance of DeltaItemKind', function() {
        // TODO: update the code to test DeltaItemKind
