...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LayoutKind', function() {
      beforeEach(function() {
        instance = EndearingAppweb.LayoutKind;
      });

      it('should create an instance of LayoutKind', function() {
        // TODO: update the code to test LayoutKind
