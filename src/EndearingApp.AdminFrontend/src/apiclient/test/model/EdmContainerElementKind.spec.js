...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdmContainerElementKind', function() {
      beforeEach(function() {
        instance = EndearingAppweb.EdmContainerElementKind;
      });

      it('should create an instance of EdmContainerElementKind', function() {
        // TODO: update the code to test EdmContainerElementKind
