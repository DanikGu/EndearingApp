...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FieldAttributes', function() {
      beforeEach(function() {
        instance = EndearingAppweb.FieldAttributes;
      });

      it('should create an instance of FieldAttributes', function() {
        // TODO: update the code to test FieldAttributes
      ...
      it('should have the property _38144', function() {
        expect(instance).to.have.property('_38144');
        expect(instance._38144).to.be(38144);
      });
