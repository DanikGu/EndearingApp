...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StructLayoutAttribute', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.StructLayoutAttribute();
      });

      it('should create an instance of StructLayoutAttribute', function() {
        // TODO: update the code to test StructLayoutAttribute
        expect(instance).to.be.a(EndearingAppweb.StructLayoutAttribute);
      });
