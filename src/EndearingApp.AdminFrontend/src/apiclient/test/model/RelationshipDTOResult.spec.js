...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RelationshipDTOResult', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.RelationshipDTOResult();
      });

      it('should create an instance of RelationshipDTOResult', function() {
        // TODO: update the code to test RelationshipDTOResult
        expect(instance).to.be.a(EndearingAppweb.RelationshipDTOResult);
      });
