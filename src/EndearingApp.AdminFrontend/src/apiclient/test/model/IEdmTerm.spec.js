...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IEdmTerm', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.IEdmTerm();
      });

      it('should create an instance of IEdmTerm', function() {
        // TODO: update the code to test IEdmTerm
        expect(instance).to.be.a(EndearingAppweb.IEdmTerm);
      });
      ...
      it('should have the property appliesTo (base name: "appliesTo")', function() {
        // TODO: update the code to test the property appliesTo
        expect(instance).to.have.property('appliesTo');
        // expect(instance.appliesTo).to.be(expectedValueLiteral);
      });
