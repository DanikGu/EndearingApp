...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OptionSetDefinitionDTO', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.OptionSetDefinitionDTO();
      });

      it('should create an instance of OptionSetDefinitionDTO', function() {
        // TODO: update the code to test OptionSetDefinitionDTO
        expect(instance).to.be.a(EndearingAppweb.OptionSetDefinitionDTO);
      });
