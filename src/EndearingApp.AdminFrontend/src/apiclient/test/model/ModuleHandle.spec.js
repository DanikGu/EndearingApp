...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModuleHandle', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.ModuleHandle();
      });

      it('should create an instance of ModuleHandle', function() {
        // TODO: update the code to test ModuleHandle
        expect(instance).to.be.a(EndearingAppweb.ModuleHandle);
      });
