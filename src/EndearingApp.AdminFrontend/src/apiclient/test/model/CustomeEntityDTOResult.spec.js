...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomeEntityDTOResult', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.CustomeEntityDTOResult();
      });

      it('should create an instance of CustomeEntityDTOResult', function() {
        // TODO: update the code to test CustomeEntityDTOResult
        expect(instance).to.be.a(EndearingAppweb.CustomeEntityDTOResult);
      });
