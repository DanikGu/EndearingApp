...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FieldInfo', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.FieldInfo();
      });

      it('should create an instance of FieldInfo', function() {
        // TODO: update the code to test FieldInfo
        expect(instance).to.be.a(EndearingAppweb.FieldInfo);
      });
      ...
      it('should have the property isInitOnly (base name: "isInitOnly")', function() {
        // TODO: update the code to test the property isInitOnly
        expect(instance).to.have.property('isInitOnly');
        // expect(instance.isInitOnly).to.be(expectedValueLiteral);
      });

      it('should have the property isLiteral (base name: "isLiteral")', function() {
        // TODO: update the code to test the property isLiteral
        expect(instance).to.have.property('isLiteral');
        // expect(instance.isLiteral).to.be(expectedValueLiteral);
      });

      it('should have the property isNotSerialized (base name: "isNotSerialized")', function() {
        // TODO: update the code to test the property isNotSerialized
        expect(instance).to.have.property('isNotSerialized');
        // expect(instance.isNotSerialized).to.be(expectedValueLiteral);
      });

      it('should have the property isPinvokeImpl (base name: "isPinvokeImpl")', function() {
        // TODO: update the code to test the property isPinvokeImpl
        expect(instance).to.have.property('isPinvokeImpl');
        // expect(instance.isPinvokeImpl).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property fieldHandle (base name: "fieldHandle")', function() {
        // TODO: update the code to test the property fieldHandle
        expect(instance).to.have.property('fieldHandle');
        // expect(instance.fieldHandle).to.be(expectedValueLiteral);
      });
