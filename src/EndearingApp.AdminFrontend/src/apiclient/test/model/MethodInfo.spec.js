...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MethodInfo', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.MethodInfo();
      });

      it('should create an instance of MethodInfo', function() {
        // TODO: update the code to test MethodInfo
        expect(instance).to.be.a(EndearingAppweb.MethodInfo);
      });
      ...
      it('should have the property returnParameter (base name: "returnParameter")', function() {
        // TODO: update the code to test the property returnParameter
        expect(instance).to.have.property('returnParameter');
        // expect(instance.returnParameter).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property returnTypeCustomAttributes (base name: "returnTypeCustomAttributes")', function() {
        // TODO: update the code to test the property returnTypeCustomAttributes
        expect(instance).to.have.property('returnTypeCustomAttributes');
        // expect(instance.returnTypeCustomAttributes).to.be(expectedValueLiteral);
      });
