...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OptionSetDefinitionDTOResult', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.OptionSetDefinitionDTOResult();
      });

      it('should create an instance of OptionSetDefinitionDTOResult', function() {
        // TODO: update the code to test OptionSetDefinitionDTOResult
        expect(instance).to.be.a(EndearingAppweb.OptionSetDefinitionDTOResult);
      });
