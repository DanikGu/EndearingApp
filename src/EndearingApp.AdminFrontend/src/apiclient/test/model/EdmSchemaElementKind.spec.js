...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdmSchemaElementKind', function() {
      beforeEach(function() {
        instance = EndearingAppweb.EdmSchemaElementKind;
      });

      it('should create an instance of EdmSchemaElementKind', function() {
        // TODO: update the code to test EdmSchemaElementKind
