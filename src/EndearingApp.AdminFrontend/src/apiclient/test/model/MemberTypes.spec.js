...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MemberTypes', function() {
      beforeEach(function() {
        instance = EndearingAppweb.MemberTypes;
      });

      it('should create an instance of MemberTypes', function() {
        // TODO: update the code to test MemberTypes
      ...
      it('should have the property _191', function() {
        expect(instance).to.have.property('_191');
        expect(instance._191).to.be(191);
      });
