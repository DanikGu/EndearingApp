...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataEntitySetInfo', function() {
      beforeEach(function() {
        instance = new EndearingAppweb.ODataEntitySetInfo();
      });

      it('should create an instance of ODataEntitySetInfo', function() {
        // TODO: update the code to test ODataEntitySetInfo
        expect(instance).to.be.a(EndearingAppweb.ODataEntitySetInfo);
      });
