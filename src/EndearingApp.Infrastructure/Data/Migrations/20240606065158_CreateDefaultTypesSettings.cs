...
using static EndearingApp.Core.SystemSettings.Consts;
...
/// <inheritdoc />
public partial class CreateDefaultTypesSettings : Migration
{
  /// <inheritdoc />
