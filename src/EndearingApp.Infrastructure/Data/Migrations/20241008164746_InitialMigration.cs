    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CustomEntityMetadataId = table.Column<Guid>(type: "uuid", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_FormMetadata_CustomEntity_CustomEntityId",
                    column: x => x.CustomEntityId,
                    principalSchema: "customization",
                    principalTable: "CustomEntity",
                    principalColumn: "Id",
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ReferencedCustomEntityId = table.Column<Guid>(type: "uuid", nullable: false),
                ReferencedFieldId = table.Column<Guid>(type: "uuid", nullable: false),
                ConstraintName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateIndex(
            name: "IX_FormMetadata_CustomEntityId",
            table: "FormMetadata",
            column: "CustomEntityId");
